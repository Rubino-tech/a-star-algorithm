...
public class MainPanel extends JPanel implements Runnable {
    ...
    // SCREEN SETTINGS
    final int maximumCols = 100;             // * setting
    final int maximumRows = 70;             // * setting
